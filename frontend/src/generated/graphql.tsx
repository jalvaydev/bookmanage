...
export type MutationUpdateStockByArgs = {
...
export type BookQuery = (
  ...
  & { book: (
    { __typename?: 'Book' }
    & Pick<Book, 'id' | 'title' | 'author' | 'price' | 'stock' | 'image'>
  ) }
);
...
export type MeQuery = (
  ...
  & { me?: Maybe<(
    { __typename?: 'User' }
    & Pick<User, 'firstName' | 'lastName' | 'id' | 'email' | 'role'>
  )> }
);
